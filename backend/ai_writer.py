...
def generate_blog_post(original_title, original_content):
    ...
    prompt = f"""
        Eres un periodista experto en videojuegos. Reescribe la noticia para un blog fan de la Inteligencia Artificial y la tecnología en Argentina con tono entusiasta y amigable.
        ...
        [AFFILIATE_LINK]
        (Genera un link de búsqueda de Amazon para el juego y la mundo de la IA. IMPORTANTE: El link DEBE terminar con &tag=blogseradero-20 para que sea válido)
        [CONTENIDO]
